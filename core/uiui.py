...
class ImageDialog(QMainWindow):
    ...
    def init_ui(self, communicator):
        ...
        # Events
        actionNew_patient.triggered.connect(lambda: self.mb_file_new_trigger(communicator))

        # action3d.triggered.connect(self.mb_procedues_brain3d)
        ...
        self.mb_actions.setEnabled(False)
        self.show()
