...
\hline 
2 & reconstruccted image & image with intensity correction & image reconstruction \tabularnewline
\hline 
3  &  &  & \tabularnewline
\hline 
...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{9Preprocessing}\caption{Triangulation for the 15 patterns. \label{fig:Preprocessing}}
\end{figure}
...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{9Segmentation}\caption{Triangulation for the 15 patterns. \label{fig:Segment}}
\end{figure}
...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{MarchingCubes}\caption{Triangulation for the 15 patterns. \label{fig:Marching cubes}}
\end{figure}
...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{m11_spherexyz}\caption{Visualization of pixels taken to interpolate} \label{fig:m11_spherexyz }
\end{figure}
