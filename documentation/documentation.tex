...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{figures/9Preprocessing}\caption{Triangulation for the 15 patterns. \label{fig:Preprocessing}}
\end{figure}
...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{figures/9Segmentation}\caption{Triangulation for the 15 patterns. \label{fig:Segment}}
\end{figure}
