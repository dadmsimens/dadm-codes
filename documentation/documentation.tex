...
\hline 
Malwina Molendowska &  26-Nov-2017 & Description of module 1 added\tabularnewline
\hline 
...
\newline Interpolation is a method of constructing new points based on the existing ones. In other words finding a value of a new point in High Resolution (HR) image based on points in Low Resolution (LR) pictures. 
