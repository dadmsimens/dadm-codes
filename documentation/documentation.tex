...
\shortauthor{SIMENS}
\titlePL{DADM project documentation}
\titleEN{}
...
\hline
Klaudia Gugulska &23-Jan-2018 &  Module 2 implementation description added\tabularnewline
\hline
Magdalena Kucharska &23-Jan-2018 &  Module 9 implementation description added\tabularnewline
\hline
Magdalena Kucharska &24-Jan-2018 &  Module 9 unity tests description added\tabularnewline
\hline
Klaudia Gugulska &24-Jan-2018 &  Final Module 2 documentation added\tabularnewline
\hline
Magdalena Rychlik &24-Jan-2018 &  Module 4 addition to tests\tabularnewline
\hline
Anna Grzywa &24-Jan-2018 &  Module 8 documentation\tabularnewline
\hline
Karolina Gajewska &24-Jan-2018 &  Final documentation\tabularnewline
\hline
Karolina Gajewska &27-Jan-2018 &  Module 11 - description of class and information about plane in gui added \tabularnewline
\hline
Eliza Kowalczyk &28-Jan-2018 &  Module 10 - Images added, final version \tabularnewline
\hline
Anna Grzywa &29-Jan-2018 &  Module 8 - final version \tabularnewline
\hline
Sylwia Mól & 30-Jan-2018 & Prject management decription\tabularnewline
\hline
\end{tabular}
...
To organize this project we used CPM methodology (Critical Path Method). The methodology is basen on the concept taht there are some critical tasks which cannot be started until previousone has been finished. The following steps were taken:
\begin{itemize}
\item 1. Arrangements: python version, repo, communication platform.
\item 2. Research. Initial dependencies scheme.
\item 3. Out/in signals for each module. Initial version of core, visualization and GUI.
\item 4. Initial documentation: theoretical descriptions. 
\item 5. Prototyping (Matlab or Python).
\item 6. Final version of dependencies scheme. Core- final version. 
\item 7. Preparing functionality of each module - coding in Python.
\item 8. Testing.
\item9. Modules merging.
\item10. Documentation - final version.
\end{itemize}
Each step was assigned to one ore more groups as follows: 
\begin{itemize}
\item D- developers
\item CT - core team (software architect, visualization engineer, GUI engineer)
\item PM - project manager


\end{itemize}
Critical path (in red) and other paths (in black) are shown in fig. 
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{figures/schemacik}\caption{Critical path}
\label{fig:figures/schemacik}
\end{figure}
Every member of the group was working remotely using his/her own computer. Team members took part in 4 meetings with following agenda:
\begin{itemize}
\item 1. 6.11.17 - initial dependencies scheme, discussion about communication, research results discussion, next steps
\item 2. 11.12.17 - presentation scetches, first results, discussion about difficulties and potential problems, next steps
\item 3. 14.11.17 - meeting with the supervisor - presentations, discussion about progress
\item 4. 11.01.18 - meeting with supervisor - presentations, first results
...
\hline  Module  & Input  & Output  & Before that module\tabularnewline \hline  \hline  1 & \textbf{k}-space signals  &  \textbf{x}-space fully reconstructed data  & ——–\tabularnewline \hline  2 & reconstruccted image & image with intensity correction & image reconstruction \tabularnewline \hline  3  & reconstructed image  & estimated noise map  & reconstruction \tabularnewline \hline  4 & reconstructed image & Rician noise-free image & noise estimation \tabularnewline \hline  5 & image, noise map & Rician noise-free image & \makecell{reconstruction, \\ noise estimation} \tabularnewline \hline  6 & \makecell{reconstructed, normalized image;\\ gradient-sequence vectors} & \makecell{estimated diffusion tensor 3D \\ 6-channel image}& modules 1-5, 8* \tabularnewline \hline  8 & image & skull stripping mask or image without non-brain tissues & reconstruction\tabularnewline \hline  9 & image without non-brain tissues & segmentated image & skull stripping \tabularnewline \hline  10 & 320x240 image  & 640x480 image  & denoised data \tabularnewline \hline  11  &segmentated image & new window of application & segmentation \tabularnewline \hline  12& many images from one examination & one image from non-standard perspective & denoised data\tabularnewline \hline  \end{tabular}\end{sideways}\\
...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{figures/Schemat_projektu}\caption{Dependencies between modules}
...
\input{"User guide/Requirements.tex"}

\input{"User guide/Instruction.tex"}



\chapter{Detailed description}

\input{"Detailed description/Module1.tex"}

\input{"Detailed description/Module2.tex"}

\input{"Detailed description/Module3.tex"}

\input{"Detailed description/Module4.tex"}

\input{"Detailed description/Module5.tex"}

\input{"Detailed description/Module6.tex"}

\input{"Detailed description/Module8.tex"}

\input{"Detailed description/Module9.tex"}

\input{"Detailed description/Module10.tex"}

\input{"Detailed description/Module11.tex"}

\input{"Detailed description/Module12.tex"}
...
\input{"Implementation/Engine"}

\input{"Implementation/Visualisation"}

\input{"Implementation/Module1.tex"}

\input{"Implementation/Module2.tex"}

\input{"Implementation/Module3.tex"}

\input{"Implementation/Module4.tex"}

\input{"Implementation/Module5.tex"}

\input{"Implementation/Module6.tex"}

\input{"Implementation/Module8.tex"}

\input{"Implementation/Module9.tex"}

\input{"Implementation/Module10.tex"}

\input{"Implementation/Module11.tex"}

\input{"Implementation/Module12.tex"}



\chapter{Results and tests}

\input{"Tests/Module1.tex"}

\input{"Tests/Module2.tex"}

\input{"Tests/Module3.tex"}

\input{"Tests/Module4.tex"}

\input{"Tests/Module5.tex"}

\input{"Tests/Module6.tex"}

\input{"Tests/Module8.tex"}

\input{"Tests/Module9.tex"}

\input{"Tests/Module10.tex"}

\input{"Tests/Module11.tex"}

\input{"Tests/Module12.tex"}
