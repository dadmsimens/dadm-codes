...
The aim of this project is to create the system for MRI data pre-processing and post-processing using Python, SciPy, Cython and Qt5 (detailed description of tools available in chapter {\it Implementation}, section {\it Tools}). The project is divided into 11 modules. The application allows to <... to be continued - detailed description what you can do in this app, possiblities, choose etc.>
...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{figures/drzewo}\caption{Dependencies between modules}
