...
To prepare brain MRI for segmentation, it is necessary to  perform several preprocessing steps. 

% (Fig. \ref{fig:Preprocessing steps})

%\begin{figure}[H]
%\centering{}\includegraphics[scale=0.7]{figures/9Preprocessing.png}\caption{Preprocessing steps: (a) the original T 1 -W MR image of the adult brain; (b) the brain tissue image after removing nonbrain structures; (c) the bias field; (d) the brain tissue image after bias field correction. \label{fig:Preprocessing steps}}
%\end{figure}
...
%(Fig. \ref{fig:Brain segmentation}).

%\begin{figure}[H]
%\centering{}\includegraphics[scale=0.7]{figures/9Segmentation.png}\caption{An example of the brain MRI segmentation with an original MR image (a) and segmented image with three labels: WM, GM, and CSF (b). \label{fig:Brain segmentation}
%\end{figure}
...
\begin{figure}[H]
\centering{}\includegraphics[scale=0.7]{figures/m11_spherexyz}\caption{Visualization of pixels taken to interpolate} \label{fig:m11_spherexyz }
\end{figure}
